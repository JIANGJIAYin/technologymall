        ...
        <section class="container clearfix">
          ...
          <aside class="filter-wrap">
            <div class="filter-container">
              <!--价格过滤-->
              <p class="filter-title"><i class="iconfont">&#xe627;</i><span class="text">笔记本价格</span></p>
              <div class="filter price-filter" v-bind:class="{'on-click':priceChecked==='All'}" v-on:click="priceFilter('All')">
              ...
              <div v-for="(price,index) in priceList">
                <div class="filter price-filter" v-bind:class="{'on-click':priceChecked==index}" v-on:click="priceFilter(index)">
                  <i class="iconfont">&#xe60e;</i>
                  {{price.gtPrice}}{{price.ltePrice}}
                </div>
              </div>

              <!--类型过滤-->
              <p class="filter-title"><i class="iconfont">&#xe637;</i><span class="text">笔记本类型</span></p>
          ...
          <article class="phone-list-wrap">
            <ul class="clearfix phones">
              <li class="phone-list" v-for="noteBook in noteBookList">
                <img :src="'/static/img/cartImg/'+noteBook.productImage" :title="noteBook.productName">
                <p class="phone-name">{{noteBook.productName}}</p>
                <p class="phone-price">
                  <i class="iconfont">&#xe60e;</i>{{noteBook.salePrice}}
                  <i class="iconfont cart" @click="addCart(noteBook.productId)">&#xe69a;</i>
                </p>
              </li>
  ...
  import axios from 'axios'
    export default {
      ...
      mounted(){
        ...
        noteBook.style.color="#00c3f5";
        this.noteBookShow();
      },
      methods: {
          noteBookShow(){
            axios.get('/noteBooks/list',{
              params: {
