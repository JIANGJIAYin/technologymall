        ...
        <section class="container clearfix">
          <aside class="filter-wrap">
            <div class="filter-container">
              <p class="filter-title"><i class="iconfont">&#xe627;</i><span class="text">耳机价格</span></p>
              ...
              <p class="filter-title"><i class="iconfont">&#xe60c;</i><span class="text">耳机类型</span></p>
          ...
          <article class="phone-list-wrap">
            <ul class="clearfix phones">
              <li class="phone-list" v-for="earPhone in earPhoneList">
                <img :src="'/static/img/cartImg/'+earPhone.productImage" :title="earPhone.productName">
                <p class="phone-name">{{earPhone.productName}}</p>
                <p class="phone-price">
                  <i class="iconfont">&#xe60e;</i>{{earPhone.salePrice}}
                  <i class="iconfont cart" @click="addCart(earPhone.productId)">&#xe69a;</i>
                </p>
              </li>
  ...
  import axios from 'axios'
    export default {
      ...
      mounted(){
        ...
        earPhone.style.color='#00c3f5';
        this.earPhoneShow();
      },
      methods: {
          earPhoneShow(){
            axios.get('/earPhones/list',{
              params:{
              ...
              if (res.status == '0') {
                this.earPhoneList=res.result;
                if (this.earPhoneList == '') {
                  this.emptyShow=true;
                }else{
